...
public class EditServlet extends HttpServlet {
    ...
    protected void doOptions(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        setAccessControlHeaders(resp); resp.setHeader("Access-Control-Allow-Origin", "*"); // Allow requests from any origin
	     resp.setHeader("Access-Control-Allow-Methods", "GET"); // Allow only GET requests
